...
![工厂方法模式类图](https://yoreay.github.io/tempo/img/factory.png)

## 抽象工厂方法
> 提供一个接口，用于创建相关或依赖对象的家族，而不需要明确指定具体类。

![抽象工厂方法模式类图](https://yoreay.github.io/tempo/img/abstractFactory.png)
...
![命令模式类图](https://yoreay.github.io/tempo/img/command.png)
...
![适配器模式类图](https://yoreay.github.io/tempo/img/adapter.png)

## 外观模式
> 提供了一个统一的几口，用来访问子系统中的一群接口。外观定义了一个高层接口，让子系统更容易使用。

![外观模式类图](https://yoreay.github.io/tempo/img/facade.png)
...
* 适配器模式有两种形式：对象适配器和类适配器。类适配器需要用到多继承，所以在java中并不适用。
* 你可以为一个子系统实现一个以上的外观。
...
![迭代器模式类图](https://yoreay.github.io/tempo/img/iterator.png)
...
![组合模式类图](https://yoreay.github.io/tempo/img/composite.png)
...
* 组合结构内的任意对象为组件，组件可以是组合，也可以是叶子节点。
...
![状态模式类图](https://yoreay.github.io/tempo/img/state.png)
...
![代理模式类图](https://yoreay.github.io/tempo/img/proxy.png)

要点：

* 代理模式为另外一个对象提供代表，以便控制客户对象的访问，管理访问的方式有许多种。
* 远程代理管理客户和远程对象之间的交互。
* 虚拟代理控制访问实例化开销大的对象。
* 保护代理基于调用者控制对象方法的访问。
